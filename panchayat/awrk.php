	...
	<div class="container">
		...
		<h3>Active Work</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <?php
                        $selj=mysqli_query($dbcon,"select * from job_data where pid='$pid' and st='1'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo $rj[2] ?>
                                    <a href="awrk.php?wid=<?php echo $rj[0] ?>"><span class="label label-danger pull-right">More</span></a>
                                </td>
                            </tr>
                            <?php
                            }
