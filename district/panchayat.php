...
{    
    ...
    $pas=$_POST['pas'];
    $con=$_POST['con'];
    $ins=mysqli_query($dbcon,"INSERT INTO `padmin_data`(`sid`, `did`, `pnme`, `padmin`, `uid`, `con`, `st`) VALUES ('$sid','$did','$pn','$pdn','$uid','$con','1')");
    if($ins>0)
    {
        $ins1=mysqli_query($dbcon,"INSERT INTO `user_log`(`uid`, `pas`, `typ`, `st`) VALUES ('$uid','$pas','padmin','1')");
        if($ins1>0)
        {
            header("location:panchayat.php?suc=1");
        }
    }
}
?>
					...
					<span class="menu"><img src="../tmplate/images/menu.png" alt=" "/></span>
						<nav class="cl-effect-3">
							<ul class="nav1">
								...
								<li class="active"><a href="panchayat.php">Panchayat</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post">
                            ...
                            <tr>
                                <td>
                                    <b>Panchayat Admin Name</b>
                                    <input type="text" name="pdn" class="form-control" required=""/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <div class="col-lg-6">
                        <?php
                        $selst=mysqli_query($dbcon,"select * from padmin_data where sid='$sid' and did='$did'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="list.php?pid=<?php echo $rst[0] ?>">More</a></td>
                            </tr>
                            <?php
                            }
                            ?>
