...
<!-- about -->
	...
	<div class="container">
		<div class="price">
            ...
            <?php
            $seld=mysqli_query($dbcon,"select * from padmin_data where sid='$sid' and did='$did'");
            $i=0;
		...
		<div class="<?php echo $cls ?>">
			...
			<ul>
                            <?php
                            $seln=mysqli_query($dbcon,"select * from nregs where pid='$rd[0]'");
                            ?>
				<li><span><?php echo mysqli_num_rows($seln) ?></span> NREGS</li>
                                <?php
                            $seln=mysqli_query($dbcon,"select * from job_data where pid='$rd[0]' and st='2'");
                            ?>
				<li><span><?php echo mysqli_num_rows($seln) ?></span> Completed Work</li>
                                <?php
                            $seln=mysqli_query($dbcon,"select * from job_data where pid='$rd[0]' and st='0'");
                            ?>
				<li><span><?php echo mysqli_num_rows($seln) ?></span> New Work</li>
