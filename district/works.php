...
session_start();
if(isset($_SESSION['dadmin']))
{
    $uid=$_SESSION['dadmin'];
    $seld=mysqli_query($dbcon,"select * from dadmin_data where uid='$uid'");
...
<div class="container" style="padding: 10px;">
    <div class="col-lg-4">
        <b>Welcome <?php echo $rd[3] ?></b>
    </div>
    <div class="col-lg-4">
        <b><?php echo $rsn[1] ?>,<?php echo $rdis[2] ?></b>
    </div>
	...
	<div id="pricing" class="pricing">
            <div class="container">
                <div class="col-md-6">
                        ...
                        <?php
                        $selj=mysqli_query($dbcon,"select * from job_data where did='$did'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><b><?php echo $rj[2] ?></b><br /><?php echo substr($rj[3],0,50) ?>....</td>
                              
                                <td>
                                    <a href="works.php?wid=<?php echo $rj[0] ?>"><span class="label label-danger pull-right">More</span></a>
                                </td>
                            </tr>
                            <?php
                            }
                ...
                <div class="col-md-6">
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                <td style="width: 50%">
                                    <iframe src="../panchayat/location.php?lat=<?php echo $rw[8] ?>&lng=<?php echo $rw[9] ?>" style="width: 100%; height: 200px;" ></iframe>
                                </td>
                                <td>
                                    <b><?php echo$rw[2] ?></b>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    if($rw[11]=="0")
                                    {
                                        echo"<b><center>Not Assigned</center></b>";
                                    }
                                    if($rw[11]=="1")
                                    {
                                        echo"<b><center>Active Work</center></b>";
                                    }
                                    if($rw[11]=="2")
                                    {
                                        echo"<b><center>Work Completed</center></b><br />";
                                        $seldt=mysqli_query($dbcon,"select distinct dt from wrk_attnd where wid='$wid'");
                                                    while($rdt=mysqli_fetch_row($seldt))
                                                    {
                                                        echo "<b>$rdt[0]</b><br />";
                                                    $chk=mysqli_query($dbcon,"select * from wrk_attnd where dt='$rdt[0]' and wid='$wid'");
