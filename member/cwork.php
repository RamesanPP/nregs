		...
		<h3>Our Assigned Work</h3>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="cwork.php?wid=<?php echo $rw[0] ?>" class="label label-danger">More</a></td>
                            </tr>
                            <?php
                            }
                            ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        {
                            $wid=$_GET['wid'];
                            $selw=mysqli_query($dbcon,"select * from job_data,user_data,job_assign where job_assign.jid=job_data.id and user_data.uid=job_data.uid and job_data.id='$wid'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo date("d-M-Y",strtotime($rw[29])) ?></td>
                            </tr>
                            <tr>
