	...
	<div class="container">
          <h3>My Attendance</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <?php
                        $sel1=mysqli_query($dbcon,"select distinct(wid) from wrk_attnd where mid='$uid'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            <tr>
                                <td>#</td>
                                <td colspan="2">Work Information</td>
                            </tr>
                            <?php
                            $i=0;
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $sel2=mysqli_query($dbcon,"select * from job_data where id='$r1[0]'");
                                    $r2=mysqli_fetch_row($sel2);
                                    echo $r2[2];
                                    ?>
                                    <div style="float: right;">Rs.
                                    <?php
                                    $selamt=mysqli_query($dbcon,"select sum(amt) from wrk_attnd where mid='$uid' and wid='$r1[0]'");
                                    $ramt=mysqli_fetch_row($selamt);
                                    echo $ramt[0];
                                    ?>/-
                                    </div>
                                </td>
                                <td><a href="attndnce.php?wid=<?php echo $r1[0] ?>"><span class="fa fa-eye"></span>View</a></td>
                            </tr>
                            <?php
                            }
                            ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        if(isset($_GET['wid']))
                        {
                            $sel4=mysqli_query($dbcon,"select * from wrk_attnd where wid='".$_GET['wid']."' and mid='$uid'");
                        ...
                        <table style="width: 100%" class="table table-bordered">
                            ...
                            <?php
                            $i=0;
                            while($r4=mysqli_fetch_row($sel4))
                            {
                                $i++;
                                ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo date("d-M-Y",strtotime($r4[7])) ?></td>
                                <td>
                                    <?php
                                    if($r4[8]=="1")
                                    {
